...
public class AllAppsQsbLayout extends AbstractQsbLayout
    implements SearchUiManager, WallpaperColorInfo.OnChangeListener {
  ...
  public AllAppsQsbLayout(final Context context, final AttributeSet set, final int n) {
    ...
    mSpring =
        new SpringAnimation(
            this,
            new FloatPropertyCompat<AllAppsQsbLayout>("allAppsQsbLayoutSpringAnimation") {
              @Override
  ...
  public void addOnScrollRangeChangeListener(
      final SearchUiManager.OnScrollRangeChangeListener onScrollRangeChangeListener) {
    mActivity
        .getHotseat()
            ...
            new View.OnLayoutChangeListener() {
              ...
              public void onLayoutChange(
                ...
                if (mActivity.getDeviceProfile().isVerticalBarLayout()) {
                  ...
                  onScrollRangeChangeListener.onScrollRangeChanged(
                      bottom
                          - HotseatQsbWidget.getBottomMargin(mActivity)
                          - (((ViewGroup.MarginLayoutParams) getLayoutParams()).topMargin
                              + (int) getTranslationY()
                              + getResources().getDimensionPixelSize(R.dimen.qsb_widget_height)));
                }
              }
            });
  }
  ...
  public void initialize(AlphabeticalAppsList appsList, AllAppsRecyclerView recyclerView) {
    ...
    recyclerView.setPadding(
        ...
        getLayoutParams().height / 2
            + getResources().getDimensionPixelSize(R.dimen.all_apps_extra_search_padding),
    ...
    ((ViewGroup.MarginLayoutParams) getLayoutParams()).topMargin +=
        getResources()
            .getDimensionPixelSize(
                statusBarHeightId > 0 ? statusBarHeightId : R.dimen.status_bar_height);
  }
  ...
  public void onExtractedColorsChanged(final WallpaperColorInfo wallpaperColorInfo) {
    ...
    bz(
        ColorUtils.compositeColors(
            ColorUtils.compositeColors(
                color, Themes.getAttrColor(mActivity, R.attr.allAppsScrimColor)),
