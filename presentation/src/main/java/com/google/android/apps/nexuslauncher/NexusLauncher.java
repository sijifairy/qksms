...
public class NexusLauncher {
  ...
  class NexusLauncherCallbacks
      implements LauncherCallbacks,
    ...
    public void onCreate(final Bundle bundle) {
      ...
      mClient =
          new LauncherClient(
              ...
              mOverlay,
              new StaticInteger(
                  (prefs.getBoolean(SettingsActivity.ENABLE_MINUS_ONE_PREF, true) ? 1 : 0)
                      | 2
                      | 4
                      | 8));
      ...
      mUiInformation.putInt(
          "system_ui_visibility", mLauncher.getWindow().getDecorView().getSystemUiVisibility());
    ...
    Launcher.CustomContentCallbacks mCustomContentCallbacks =
        new Launcher.CustomContentCallbacks() {

          // Custom content is completely shown. {@code fromResume} indicates whether this was
          // caused
    ...
    public void populateCustomContentContainer() {
      View v = View.inflate(mLauncher, R.layout.main_holder, null);
      mLauncher.addToCustomContentPage(v, mCustomContentCallbacks, "");
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
      if (SettingsActivity.ENABLE_MINUS_ONE_PREF.equals(key)) {
        ...
        StaticInteger i =
            new StaticInteger(
                (sharedPreferences.getBoolean(SettingsActivity.ENABLE_MINUS_ONE_PREF, true) ? 1 : 0)
                    | 2
                    | 4
                    | 8);
    ...
    public void onExtractedColorsChanged(WallpaperColorInfo wallpaperColorInfo) {
      ...
      mUiInformation.putInt(
          "background_color_hint", primaryColor(wallpaperColorInfo, mLauncher, alpha));
      mUiInformation.putInt(
          "background_secondary_color_hint", secondaryColor(wallpaperColorInfo, mLauncher, alpha));
      mUiInformation.putBoolean(
          "is_background_dark", Themes.getAttrBoolean(mLauncher, R.attr.isMainColorDark));
  ...
  public static int primaryColor(
      WallpaperColorInfo wallpaperColorInfo, Context context, int alpha) {
  ...
  public static int secondaryColor(
      WallpaperColorInfo wallpaperColorInfo, Context context, int alpha) {
    return compositeAllApps(
        ColorUtils.setAlphaComponent(wallpaperColorInfo.getSecondaryColor(), alpha), context);
  }
