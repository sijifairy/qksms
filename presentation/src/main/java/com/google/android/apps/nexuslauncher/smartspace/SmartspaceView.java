...
public class SmartspaceView extends FrameLayout
            ...
            try {
              ...
              LauncherAppsCompat.getInstance(getContext())
                  .showAppDetailsForProfile(
                      new ComponentName(DynamicIconProvider.GOOGLE_CALENDAR, ""),
                      Process.myUserHandle());
            }
          }
        };

    mWeatherClickListener =
        new OnClickListener() {
          @Override
          public void onClick(View v) {
  ...
  private void setGoogleSans(TextView... views) {
    Typeface tf =
        Typeface.createFromAsset(getContext().getAssets(), "fonts/GoogleSans-Regular.ttf");
    ...
    return dp.cC(
        TextUtils.ellipsize(
                ...
                getWidth()
                    - getPaddingLeft()
                    - getPaddingRight()
                    - getResources().getDimensionPixelSize(R.dimen.smartspace_horizontal_padding)
                    - dB.measureText(dp.cA(b)),
  ...
  private void cs() {
    ...
    addView(
        from.inflate(
            mDoubleLine ? R.layout.smartspace_twolines : R.layout.smartspace_singleline,
            this,
            false),
        indexOfChild);
    loadViews();
  ...
  protected final void cp(int n) {
    // ((UserEventDispatcherImpl)
    // Launcher.getLauncher(getContext()).getUserEventDispatcher()).bp(n);
  }
  ...
  public boolean onLongClick(final View view) {
    ...
    popupContainerWithArrow.populateAndShow(
        dr, Collections.EMPTY_LIST, Collections.EMPTY_LIST, list);
    return b;
  }
  ...
  final class h implements OnClickListener {
    ...
    public void onClick(final View view) {
      ...
      try {
        ...
        LauncherAppsCompat.getInstance(dZ.getContext())
            .showAppDetailsForProfile(
