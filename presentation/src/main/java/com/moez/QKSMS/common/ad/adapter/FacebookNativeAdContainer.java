...
public class FacebookNativeAdContainer extends NmNativeAdContainer {
  ...
  public FacebookNativeAdContainer(NativeAd ad) {
    this.ad = ad;
  }
  ...
  public void setAdMediaView(NmNativeAdMediaView mediaViewContainer) {
    adMediaView = new MediaView(mediaViewContainer.getContext());
  ...
  public void fillNativeAd(NmNativeAd nmNativeAd) {
    ...
    ((FacebookNativeAd) nmNativeAd).facebookNativeAd.unregisterView();
    ((FacebookNativeAd) nmNativeAd)
        .facebookNativeAd.registerViewForInteraction(
            adView, adMediaView, adIconView, clickableViews);
  }
}
