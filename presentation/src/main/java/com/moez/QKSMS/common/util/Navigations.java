...
public class Navigations {
  ...
  /**
   * Start an activity on the given context, {@link Intent#FLAG_ACTIVITY_NEW_TASK} will be added to
   * intent when the given context is not an activity context.
   */
  ...
  public static void startActivitySafely(Context context, Intent intent) {
    try {
      ...
      Toasts.showToast("Your device does not support this.");
      Log.e("StartActivity", "Cannot start activity: " + intent);
    }
  }
    ...
    try {
      ...
      Log.e(
          ...
          "Launcher does not have the permission to launch "
              ...
              + "or use the exported attribute for this activity. Error: "
              + e);
    }
  }
   ...
   * @param attachPackageName If package name of this launcher should be attached by {@link
   *     Intent#setData(Uri)}.
   */
  public static void startSystemSetting(
      Context activityContext, String action, boolean attachPackageName) {
