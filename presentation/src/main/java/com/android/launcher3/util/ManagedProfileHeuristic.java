...
/**
 * Handles addition of app shortcuts for managed profiles. Methods of class should only be called on
 * {@link LauncherModel#sWorkerThread}.
 */
public class ManagedProfileHeuristic {
  ...
  public static void onAllAppsLoaded(
      final Context context, List<LauncherActivityInfo> apps, UserHandle user) {
  ...
  public static class UserFolderInfo {
    ...
    /**
     * Returns the ItemInfo which should be added to the workspace. In case the the provided {@link
     * ShortcutInfo} or a wrapped {@link FolderInfo} or null.
     */
  ...
  /**
   * For each user, if a work folder has not been created, mark it such that the folder will never
   * get created.
   */
