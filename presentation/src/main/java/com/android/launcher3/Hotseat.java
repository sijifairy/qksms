...
public class Hotseat extends FrameLayout implements UserEventDispatcher.LogContainerProvider {
  ...
  public Hotseat(Context context, AttributeSet attrs, int defStyle) {
    ...
    mBackgroundColor =
        ColorUtils.setAlphaComponent(Themes.getAttrColor(context, android.R.attr.colorPrimary), 0);
  ...
  void resetLayout() {
    ...
    if (!FeatureFlags.NO_ALL_APPS_ICON) {
      ...
      d.setBounds(
          bounds.left,
          bounds.top + scaleDownPx / 2,
          bounds.right - scaleDownPx,
  ...
  public void updateColor(ExtractedColors extractedColors, boolean animate) {
    ...
    if (!mHasVerticalHotseat) {
      ...
      if (!animate) {
        ...
        mBackgroundColorAnimator.addUpdateListener(
        ...
        mBackgroundColorAnimator.addListener(
