...
public abstract class BaseRecyclerView extends RecyclerView
  ...
  /**
   * We intercept the touch handling only to support fast scrolling when initiated from the scroll
   * bar. Otherwise, we fall back to the default RecyclerView touch handling.
   */
  @Override
  ...
  protected void synchronizeScrollBarThumbOffsetToViewScroll(
      int scrollY, int availableScrollHeight) {
