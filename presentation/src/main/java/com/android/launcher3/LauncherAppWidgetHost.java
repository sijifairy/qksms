...
public class LauncherAppWidgetHost extends AppWidgetHost {
  ...
  @Override
  protected LauncherAppWidgetHostView onCreateView(
  ...
  protected void onProviderChanged(int appWidgetId, AppWidgetProviderInfo appWidget) {
    LauncherAppWidgetProviderInfo info =
        LauncherAppWidgetProviderInfo.fromProviderInfo(mContext, appWidget);
  ...
  public void startBindFlow(
      BaseActivity activity, int appWidgetId, AppWidgetProviderInfo info, int requestCode) {
    ...
    Intent intent =
        new Intent(AppWidgetManager.ACTION_APPWIDGET_BIND)
