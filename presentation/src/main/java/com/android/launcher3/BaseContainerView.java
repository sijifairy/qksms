...
public abstract class BaseContainerView extends FrameLayout
  ...
  public BaseContainerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    if (this instanceof AllAppsContainerView) {
      ...
      TypedArray a =
          context.obtainStyledAttributes(attrs, R.styleable.BaseContainerView, defStyleAttr, 0);
  ...
  protected void updateBackground(
    ...
    mRevealView.setBackground(
        new InsetDrawable(mBaseDrawable, paddingLeft, paddingTop, paddingRight, paddingBottom));
  ...
  /**
   * Handles the touch events that shows the workspace when clicking outside the bounds of the touch
   * delegate target view.
   */
