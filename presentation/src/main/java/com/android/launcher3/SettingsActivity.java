...
public class SettingsActivity extends Activity {
  ...
  public static class LauncherSettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      if (!Utilities.ATLEAST_OREO) {
        getPreferenceScreen()
            .removePreference(findPreference(SessionCommitReceiver.ADD_ICON_PREFERENCE_KEY));
      }
      if (!getResources().getBoolean(R.bool.notification_badging_enabled)) {
        ...
        mIconBadgingObserver =
            new IconBadgingObserver(iconBadgingPref, resolver, getFragmentManager());
  ...
  /**
   * Content observer which listens for system auto-rotate setting changes, and enables/disables the
   * launcher rotation setting accordingly.
   */
  private static class SystemDisplayRotationLockObserver extends SettingsObserver.System {
    ...
    public void onSettingChanged(boolean enabled) {
      ...
      mRotationPref.setSummary(
          enabled ? R.string.allow_rotation_desc : R.string.allow_rotation_blocked_desc);
    }
  }
  ...
  private static class IconBadgingObserver extends SettingsObserver.Secure
    ...
    public IconBadgingObserver(
        ButtonPreference badgingPref, ContentResolver resolver, FragmentManager fragmentManager) {
      super(resolver);
