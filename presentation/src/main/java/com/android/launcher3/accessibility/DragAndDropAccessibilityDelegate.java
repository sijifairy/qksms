...
public abstract class DragAndDropAccessibilityDelegate extends ExploreByTouchHelper
  ...
  /**
   * @return the view id of the top left corner of a valid drop region or {@link #INVALID_POSITION}
   *     if there is no such valid region.
   */
  ...
  public void onClick(View v) {
    onPerformActionForVirtualView(
        getFocusedVirtualView(), AccessibilityNodeInfoCompat.ACTION_CLICK, null);
  }
