...
public class LauncherAccessibilityDelegate extends AccessibilityDelegate implements DragListener {
  ...
  public LauncherAccessibilityDelegate(Launcher launcher) {
    ...
    mActions.put(
        REMOVE,
        new AccessibilityAction(REMOVE, launcher.getText(R.string.remove_drop_target_label)));
    mActions.put(
        INFO, new AccessibilityAction(INFO, launcher.getText(R.string.app_info_drop_target_label)));
    mActions.put(
        UNINSTALL,
        new AccessibilityAction(UNINSTALL, launcher.getText(R.string.uninstall_drop_target_label)));
    mActions.put(
        ADD_TO_WORKSPACE,
        new AccessibilityAction(
            ADD_TO_WORKSPACE, launcher.getText(R.string.action_add_to_workspace)));
    mActions.put(MOVE, new AccessibilityAction(MOVE, launcher.getText(R.string.action_move)));
    mActions.put(
        MOVE_TO_WORKSPACE,
        new AccessibilityAction(
            MOVE_TO_WORKSPACE, launcher.getText(R.string.action_move_to_workspace)));
    mActions.put(RESIZE, new AccessibilityAction(RESIZE, launcher.getText(R.string.action_resize)));
    mActions.put(
        DEEP_SHORTCUTS,
        new AccessibilityAction(DEEP_SHORTCUTS, launcher.getText(R.string.action_deep_shortcut)));
  }
  ...
  void performResizeAction(int action, View host, LauncherAppWidgetInfo info) {
    ...
    ((LauncherAppWidgetHostView) host)
        .updateAppWidgetSize(
            null, sizeRange.left, sizeRange.top, sizeRange.right, sizeRange.bottom);
    host.requestLayout();
   ...
   * @param dropLocation relative to {@param clickedTarget}. If provided, its center is used as the
   *     actual drop location otherwise the views center is used.
   */
