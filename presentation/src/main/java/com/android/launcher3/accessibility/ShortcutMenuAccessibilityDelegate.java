...
/**
 * Extension of {@link LauncherAccessibilityDelegate} with actions specific to shortcuts in deep
 * shortcuts menu.
 */
  ...
  public ShortcutMenuAccessibilityDelegate(Launcher launcher) {
    ...
    mActions.put(
        ...
        new AccessibilityAction(
            DISMISS_NOTIFICATION, launcher.getText(R.string.action_dismiss_notification)));
  }
