...
public class ColorExtractionAlgorithm {
  ...
  public static ColorExtractionAlgorithm newInstance(Context context) {
    return Utilities.getOverrideObject(
        ColorExtractionAlgorithm.class,
        context.getApplicationContext(),
        R.string.color_extraction_impl_class);
  }
  ...
  public Pair<Integer, Integer> extractInto(WallpaperColorsCompat inWallpaperColors) {
    ...
    final boolean supportsDarkText =
        (inWallpaperColors.getColorHints() & WallpaperColorsCompat.HINT_SUPPORTS_DARK_TEXT) != 0;
  ...
  public static Pair<Integer, Integer> applyFallback(WallpaperColorsCompat inWallpaperColors) {
    boolean light =
        inWallpaperColors != null
            && (inWallpaperColors.getColorHints() & WallpaperColorsCompat.HINT_SUPPORTS_DARK_TEXT)
                != 0;
  ...
  /**
   * Offsets all colors by a delta, clamping values that go beyond what's supported on the color
   * space.
   *
  ...
  private static final TonalPalette[] TONAL_PALETTES = {
    new TonalPalette(
        new float[] {
          ...
          0f,
          0f,
          0.01134380453752181f,
          0.015625000000000003f,
          0.024193548387096798f,
          0.027397260273972573f,
          0.017543859649122865f
        },
        new float[] {1f, 1f, 1f, 1f, 1f, 1f, 1f, 0.8434782608695652f, 1f, 1f, 1f, 1f, 1f},
        new float[] {
          0.04f,
          0.09f,
          0.14f,
    ...
    new TonalPalette(
        ...
        new float[] {
          0.05f,
          0.12f,
          0.17450980392156862f,
          0.2235294117647059f,
          0.2784313725490196f,
          0.3352941176470588f,
          0.388235294117647f,
          0.44901960784313727f,
          0.5392156862745098f,
          0.6509803921568628f,
          0.7509803921568627f,
          0.8764705882352941f
    ...
    new TonalPalette(
        ...
        new float[] {1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 0.8847736625514403f, 1f, 1f, 1f},
        new float[] {
          0.07f,
          0.12f,
          0.16f,
          0.2f,
          0.24901960784313726f,
          0.27450980392156865f,
          0.30392156862745096f,
          0.34901960784313724f,
          0.4137254901960784f,
          0.47647058823529415f,
          0.5352941176470588f,
          0.6764705882352942f,
          0.8f
        }),
    new TonalPalette(
        ...
        new float[] {
          ...
          0.12f,
          0.1588235294117647f,
          0.21176470588235297f,
          0.25882352941176473f,
          0.3f,
          0.34901960784313724f,
          0.44117647058823534f,
          0.5215686274509804f,
          0.5862745098039216f,
          0.7509803921568627f,
          0.8509803921568627f
    ...
    new TonalPalette(
        new float[] {
          ...
          0.34006734006734f,
          0.34006734006734f,
          0.34259259259259256f,
          0.3475783475783476f,
          0.34767025089605735f,
          0.3467741935483871f,
          0.3703703703703704f
        },
        new float[] {
        ...
        new float[] {
          ...
          0.3431372549019608f,
          0.38235294117647056f,
          0.49215686274509807f,
          0.6588235294117647f,
          0.7431372549019608f,
          0.8176470588235294f,
          0.8784313725490196f,
    ...
    new TonalPalette(
        new float[] {
          ...
          0.163f,
          0.162280701754386f,
          0.15032679738562088f,
          0.15879265091863518f,
          0.16236559139784948f,
          0.17443868739205526f,
          0.17824074074074076f,
          0.18674698795180725f,
          0.18692449355432778f,
          0.1946778711484594f,
          0.18604651162790695f
        },
    ...
    new TonalPalette(
        new float[] {
          ...
          0.105f,
          0.105f,
          0.10619469026548674f,
          0.11924686192468618f,
          0.13046448087431692f,
          0.14248366013071895f,
          0.1506024096385542f,
          0.16220238095238093f,
          0.16666666666666666f,
          0.16666666666666666f,
          0.162280701754386f,
          0.15686274509803924f
        },
    ...
    new TonalPalette(
        new float[] {
          ...
          0.036f,
          0.036f,
          0.03561253561253561f,
          0.05098039215686275f,
          0.07516339869281045f,
          0.09477124183006536f,
          0.1150326797385621f,
          0.134640522875817f,
          0.14640522875816991f,
          0.1582397003745319f,
          0.15773809523809523f,
          0.15359477124183002f
        },
        new float[] {1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f},
        new float[] {
          0.19f,
    ...
    new TonalPalette(
        ...
        new float[] {
          ...
          0.737142857142857f,
          0.6434108527131781f,
          0.46835443037974644f
        },
        new float[] {
          0.05f,
          0.08f,
          0.12745098039215685f,
          0.15490196078431373f,
    ...
    new TonalPalette(
        new float[] {
          ...
          0f,
          0f,
          0.009057971014492771f,
          0.026748971193415648f,
          0.041666666666666616f,
          0.05303030303030304f
        },
        new float[] {
          1f,
          1f,
    ...
    new TonalPalette(
        ...
        new float[] {
          0.25f,
          0.24590163934426232f,
          0.17880794701986752f,
          0.14606741573033713f,
          0.13761467889908252f,
          0.14893617021276592f,
          0.16756756756756758f,
          0.20312500000000017f,
          0.26086956521739135f,
          0.29999999999999966f,
          0.5000000000000004f
        },
        new float[] {
          0.18f,
    ...
    new TonalPalette(
        new float[] {
          ...
          0f,
          0f,
          0.0047348484848484815f,
          0.00316455696202532f,
          0f,
          0.9980392156862745f,
          0.9814814814814816f,
          0.9722222222222221f
    ...
    new TonalPalette(
        ...
        new float[] {
          ...
          0.5774647887323943f,
          0.5391304347826086f,
          0.46724890829694316f,
          0.4680851063829788f,
          0.462686567164179f,
          0.45679012345678977f,
          0.4545454545454551f
        },
        new float[] {
          0.12f,
          0.16f,
          0.2196078431372549f,
          0.33921568627450976f,
          0.39019607843137255f,
          0.4176470588235294f,
    ...
    new TonalPalette(
        ...
        new float[] {
          ...
          0.2980392156862745f,
          0.36666666666666664f,
          0.40588235294117647f,
          0.44705882352941173f,
          0.5568627450980392f,
          0.6352941176470588f,
          0.7392156862745098f,
          0.8431372549019608f,
    ...
    new TonalPalette(
        new float[] {
          0.469f,
          0.46732026143790845f,
          0.4718614718614719f,
          0.4793650793650794f,
          0.48071625344352614f,
          0.4829683698296837f,
          0.484375f,
          0.4841269841269842f,
          0.48444444444444457f,
          0.48518518518518516f,
          0.4907407407407408f
        },
        new float[] {
          1f,
          ...
          1f,
          0.6274509803921569f,
          0.41832669322709176f,
          0.41899441340782106f,
          0.4128440366972478f,
          0.4090909090909088f
        },
        new float[] {
          0.07f,
          0.1f,
          0.15098039215686274f,
          0.20588235294117646f,
          0.2372549019607843f,
          0.26862745098039215f,
          0.4f,
          0.5078431372549019f,
          0.6490196078431372f,
          0.7862745098039216f,
    ...
    new TonalPalette(
        ...
        new float[] {
          0.25f,
          0.24590163934426232f,
          0.19148936170212766f,
          0.1791044776119403f,
          0.18343195266272191f,
          0.18446601941747576f,
          0.1538461538461539f,
          0.15625000000000003f,
          0.15328467153284678f,
          0.15662650602409653f,
          0.151515151515151f
        },
        new float[] {
          0.05f,
    ...
    new TonalPalette(
        new float[] {
          ...
          0.02469135802469136f,
          0.031249999999999997f,
          0.03947368421052631f,
          0.04166666666666668f,
          0.043650793650793655f,
          0.04411764705882352f,
          0.04166666666666652f,
          0.04444444444444459f,
          0.05555555555555529f
        },
        new float[] {
          0.33333333333333337f,
          0.2783505154639175f,
          0.2580645161290323f,
          0.25675675675675674f,
          0.2528735632183908f,
          0.17500000000000002f,
          0.15315315315315312f,
          0.15189873417721522f,
          0.15789473684210534f,
          0.15789473684210542f
        },
        new float[] {
          0.08823529411764705f,
          0.19019607843137254f,
          0.2431372549019608f,
          0.2901960784313725f,
          0.3411764705882353f,
    ...
    new TonalPalette(
        new float[] {
          ...
          0.038f,
          0.044f,
          0.050884955752212385f,
          0.07254901960784313f,
          0.0934640522875817f,
          0.10457516339869281f,
          0.11699346405228758f,
          0.1255813953488372f,
          0.1268939393939394f,
          0.12533333333333332f,
          0.12500000000000003f,
          0.12777777777777777f
        },
        new float[] {1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f},
        new float[] {
          0.25f,
  ...
  private static final TonalPalette GREY_PALETTE =
      new TonalPalette(
  ...
  static final ColorRange[] BLACKLISTED_COLORS =
      new ColorRange[] {
        ...
        new ColorRange(new Range<>(0f, 20f), new Range<>(0.3f, 0.7f), new Range<>(0.355f, 0.653f)),

        // Red Orange
        new ColorRange(new Range<>(20f, 40f), new Range<>(0.7f, 1f), new Range<>(0.28f, 0.643f)),
        new ColorRange(new Range<>(20f, 40f), new Range<>(0.3f, 0.7f), new Range<>(0.414f, 0.561f)),
        new ColorRange(new Range<>(20f, 40f), new Range<>(0f, 3f), new Range<>(0.343f, 0.584f)),

        // Orange
        new ColorRange(new Range<>(40f, 60f), new Range<>(0.7f, 1f), new Range<>(0.173f, 0.349f)),
        new ColorRange(new Range<>(40f, 60f), new Range<>(0.3f, 0.7f), new Range<>(0.233f, 0.427f)),
        new ColorRange(new Range<>(40f, 60f), new Range<>(0f, 0.3f), new Range<>(0.231f, 0.484f)),

        // Yellow 60
        new ColorRange(new Range<>(60f, 80f), new Range<>(0.7f, 1f), new Range<>(0.488f, 0.737f)),
        new ColorRange(new Range<>(60f, 80f), new Range<>(0.3f, 0.7f), new Range<>(0.673f, 0.837f)),

        // Yellow Green 80
        new ColorRange(new Range<>(80f, 100f), new Range<>(0.7f, 1f), new Range<>(0.469f, 0.61f)),

        // Yellow green 100
        new ColorRange(new Range<>(100f, 120f), new Range<>(0.7f, 1f), new Range<>(0.388f, 0.612f)),
        new ColorRange(
            new Range<>(100f, 120f), new Range<>(0.3f, 0.7f), new Range<>(0.424f, 0.541f)),

        // Green
        new ColorRange(new Range<>(120f, 140f), new Range<>(0.7f, 1f), new Range<>(0.375f, 0.52f)),
        new ColorRange(
            new Range<>(120f, 140f), new Range<>(0.3f, 0.7f), new Range<>(0.435f, 0.524f)),

        // Green Blue 140
        new ColorRange(new Range<>(140f, 160f), new Range<>(0.7f, 1f), new Range<>(0.496f, 0.641f)),

        // Seafoam
        new ColorRange(new Range<>(160f, 180f), new Range<>(0.7f, 1f), new Range<>(0.496f, 0.567f)),

        // Cyan
        new ColorRange(new Range<>(180f, 200f), new Range<>(0.7f, 1f), new Range<>(0.52f, 0.729f)),

        // Blue
        new ColorRange(new Range<>(220f, 240f), new Range<>(0.7f, 1f), new Range<>(0.396f, 0.571f)),
        new ColorRange(
            new Range<>(220f, 240f), new Range<>(0.3f, 0.7f), new Range<>(0.425f, 0.551f)),

        // Blue Purple 240
        new ColorRange(new Range<>(240f, 260f), new Range<>(0.7f, 1f), new Range<>(0.418f, 0.639f)),
        new ColorRange(
            new Range<>(220f, 240f), new Range<>(0.3f, 0.7f), new Range<>(0.441f, 0.576f)),
        ...
        // Fuchsia
        new ColorRange(new Range<>(300f, 320f), new Range<>(0.7f, 1f), new Range<>(0.484f, 0.588f)),
        new ColorRange(
            new Range<>(300f, 320f), new Range<>(0.3f, 0.7f), new Range<>(0.48f, 0.592f)),

        // Pink
        new ColorRange(new Range<>(320f, 340f), new Range<>(0.7f, 1f), new Range<>(0.466f, 0.629f)),

        // Soft red
        new ColorRange(new Range<>(340f, 360f), new Range<>(0.7f, 1f), new Range<>(0.437f, 0.596f))
      };
