...
/**
 * Simply draws the caret drawable bottom-right aligned in the view. This ensures that we can have a
 * view with as large an area as we want (for touching) while maintaining a caret of size
...
public class PageIndicatorCaretLandscape extends PageIndicator {
  ...
  protected void onDraw(Canvas canvas) {
    ...
    canvas.translate(
        (getWidth() - drawableBounds.width()) / 2, getHeight() - drawableBounds.height());
