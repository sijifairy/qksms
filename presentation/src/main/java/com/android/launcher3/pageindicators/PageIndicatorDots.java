...
/**
 * {@link PageIndicator} which shows dots per page. The active page is shown with the current accent
 * color.
 */
public class PageIndicatorDots extends PageIndicator {
  ...
  /**
   * The current position of the active dot including the animation progress. For ex: 0.0 => Active
   * dot is at position 0 0.33 => Active dot is at position 0 and is moving towards 1 0.50 => Active
   * dot is at position [0, 1] 0.77 => Active dot has left position 0 and is collapsing towards
  ...
  /**
   * Sets up up the page indicator to play the entry animation. {@link #playEntryAnimation()} must
