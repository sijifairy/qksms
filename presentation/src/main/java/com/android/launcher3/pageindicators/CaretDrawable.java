...
public class CaretDrawable extends Drawable {
   ...
   *
   * @param progress The progress ({@value #PROGRESS_CARET_POINTING_UP} for pointing up, {@value
   *     #PROGRESS_CARET_POINTING_DOWN} for pointing down, {@value #PROGRESS_CARET_NEUTRAL} for
   *     neutral)
   */
