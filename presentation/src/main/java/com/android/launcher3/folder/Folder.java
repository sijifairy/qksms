...
public class Folder extends AbstractFloatingView
  ...
  /**
   * We avoid measuring {@link #mContent} with a 0 width or height, as this results in CellLayout
   * being measured as UNSPECIFIED, which it does not support.
   */
  ...
  protected void onFinishInflate() {
    ...
    if (!Utilities.ATLEAST_MARSHMALLOW) {
      ...
      // available.
      mFolderName.setCustomSelectionActionModeCallback(
    ...
    if (tag instanceof ShortcutInfo) {
      ...
      if (options.isAccessibleDrag) {
        mDragController.addDragListener(
            new AccessibleDragListenerAdapter(mContent, CellLayout.FOLDER_ACCESSIBILITY_DRAG) {
  ...
  /**
   * This method is intended to make the UserFolder to be visually identical in size and position to
   * its associated FolderIcon. This allows for a seamless transition into the expanded state.
   */
  ...
  private AnimatorSet getOpeningAnimator() {
    ...
    Animator reveal =
        new CircleRevealOutlineProvider((int) getPivotX(), (int) getPivotY(), 0, radius)
  ...
  public void animateOpen() {
    ...
    AnimatorSet anim =
        FeatureFlags.LAUNCHER3_NEW_FOLDER_ANIMATION
    ...
    if (mContent.getPageCount() > 1 && !mInfo.hasOption(FolderInfo.FLAG_MULTI_PAGE_ANIMATION)) {
      int footerWidth =
          mContent.getDesiredWidth() - mFooter.getPaddingLeft() - mFooter.getPaddingRight();
      ...
      anim.addListener(
          new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
              mFolderName
                  .animate()
                  .setDuration(FOLDER_NAME_ANIMATION_DURATION)
                  .translationX(0)
                  .setInterpolator(
              ...
              if (updateAnimationFlag) {
                mInfo.setOption(
                    FolderInfo.FLAG_MULTI_PAGE_ANIMATION, true, mLauncher.getModelWriter());
              }
            }
          });
    } else {
  ...
  void onDragOver(DragObject d, int reorderDelay) {
    ...
    if (mTargetRank != mPrevTargetRank) {
      ...
      if (d.stateAnnouncer != null) {
        d.stateAnnouncer.announce(
            getContext().getString(R.string.move_to_position, mTargetRank + 1));
      }
    }
    ...
    float cellOverlap =
        mContent.getCurrentCellLayout().getCellWidth() * ICON_OVERSCROLL_WIDTH_FACTOR;
  ...
  /**
   * When performing an accessibility drop, onDrop is sent immediately after onDragEnter. So we need
   * to complete all transient states based on timers.
   */
  @Override
  ...
  public void onDropCompleted(
    ...
    if (successfulDrop) {
      ...
      View icon =
          (mCurrentDragView != null && mCurrentDragView.getTag() == info)
              ? mCurrentDragView
    ...
    if (!isFlingToDelete) {
      ...
      mLauncher.exitSpringLoadedDragModeDelayed(
          successfulDrop, Launcher.EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT, null);
    }
  }
  ...
  private int getContentAreaHeight() {
    ...
    int maxContentAreaHeight =
        grid.availableHeightPx - grid.getTotalWorkspacePadding().y - mFooterHeight;
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (mContent.getChildCount() > 0) {
      int cellIconGap =
          (mContent.getPageAt(0).getCellWidth() - mLauncher.getDeviceProfile().iconSizePx) / 2;
      mFooter.setPadding(
          mContent.getPaddingLeft() + cellIconGap,
          mFooter.getPaddingTop(),
          mContent.getPaddingRight() + cellIconGap,
          mFooter.getPaddingBottom());
    }
    mFooter.measure(
        contentAreaWidthSpec, MeasureSpec.makeMeasureSpec(mFooterHeight, MeasureSpec.EXACTLY));
              ...
              if (itemCount == 1) {
                ...
                mLauncher
                    ...
                    .addOrMoveItemInDatabase(
                        finalItem, mInfo.container, mInfo.screenId, mInfo.cellX, mInfo.cellY);
              }
      ...
      setOnKeyListener(
          new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
              boolean isShiftPlusTab =
                  keyCode == KeyEvent.KEYCODE_TAB && event.hasModifiers(KeyEvent.META_SHIFT_ON);
  ...
  public void onDrop(DragObject d) {
    ...
    PendingAddShortcutInfo pasi =
        d.dragInfo instanceof PendingAddShortcutInfo ? (PendingAddShortcutInfo) d.dragInfo : null;
  ...
  public void onAdd(ShortcutInfo item, int rank) {
    ...
    mLauncher.getModelWriter().addOrMoveItemInDatabase(item, mInfo.id, 0, item.cellX, item.cellY);
  ...
  private View getViewForInfo(final ShortcutInfo item) {
    return mContent.iterateOverItems(
        new ItemOperator() {
  ...
  public List<BubbleTextView> getItemsOnPage(int page) {
    ...
    int numItemsOnCurrentPage =
        page == lastPage ? totalItemsInFolder - (itemsPerPage * page) : itemsPerPage;
