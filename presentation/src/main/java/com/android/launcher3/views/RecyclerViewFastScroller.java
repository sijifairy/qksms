...
public class RecyclerViewFastScroller extends View {
  ...
  public RecyclerViewFastScroller(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    TypedArray ta =
        context.obtainStyledAttributes(
            attrs, R.styleable.RecyclerViewFastScroller, defStyleAttr, 0);
  ...
  public void onDraw(Canvas canvas) {
    ...
    canvas.drawRoundRect(
        -halfW, 0, halfW, mRv.getScrollbarTrackHeight(), mWidth, mWidth, mTrackPaint);
  ...
  /**
   * Returns true if AllAppsTransitionController can handle vertical motion beginning at this point.
   */
  ...
  private void updatePopupY(int lastTouchY) {
    ...
    float top = lastTouchY - (FAST_SCROLL_OVERLAY_Y_OFFSET_FACTOR * height) + mRv.getPaddingTop();
    top =
        Utilities.boundToRange(top, mMaxWidth, mRv.getScrollbarTrackHeight() - mMaxWidth - height);
