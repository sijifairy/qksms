...
public class FolderAdaptiveIcon extends AdaptiveIconDrawable {
  ...
  public static FolderAdaptiveIcon createFolderAdaptiveIcon(
    ...
    final Bitmap preview =
        Bitmap.createBitmap(
            (int) (dragViewSize.x * sizeScaleFactor),
            (int) (dragViewSize.y * sizeScaleFactor),
    ...
    try {
      return new MainThreadExecutor()
          .submit(
              new Callable<FolderAdaptiveIcon>() {
                @Override
  ...
  private static FolderAdaptiveIcon createDrawableOnUiThread(
      FolderIcon icon, Bitmap badgeBitmap, Bitmap previewBitmap) {
    ...
    ShiftedBitmapDrawable foreground =
        new ShiftedBitmapDrawable(previewBitmap, margin - previewShiftX, margin - previewShiftY);
