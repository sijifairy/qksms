...
public class DragLayer extends InsettableFrameLayout {
  ...
  public void onAccessibilityStateChanged(boolean isAccessibilityEnabled) {
    mPinchListener =
        FeatureFlags.LAUNCHER3_DISABLE_PINCH_TO_OVERVIEW || isAccessibilityEnabled
            ? null
            : new PinchToOverviewListener(mLauncher);
  }
  ...
  public boolean onInterceptTouchEvent(MotionEvent ev) {
    ...
    if (mCurrentResizeFrame != null && mCurrentResizeFrame.onControllerInterceptTouchEvent(ev)) {
      ...
      if (accessibilityManager.isTouchExplorationEnabled()) {
        ...
        switch (action) {
          case MotionEvent.ACTION_HOVER_ENTER:
            isOverFolderOrSearchBar =
                isEventOverFolder(currentFolder, ev)
  ...
  public void addResizeFrame(LauncherAppWidgetHostView widget, CellLayout cellLayout) {
    ...
    mCurrentResizeFrame =
        (AppWidgetResizeFrame)
            LayoutInflater.from(mLauncher).inflate(R.layout.app_widget_resize_frame, this, false);
