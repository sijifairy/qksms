...
public abstract class BaseItemDragListener
    implements View.OnDragListener, DragSource, DragOptions.PreDragCondition {
  ...
  protected boolean onDragStart(DragEvent event) {
    ...
    createDragHelper()
        .startDrag(
            new Rect(mPreviewRect), mPreviewBitmapWidth, mPreviewViewWidth, downPos, this, options);
