...
public class DragView extends View {
  ...
  /**
   * Initialize {@code #mIconDrawable} if the item can be represented using an {@link
   * AdaptiveIconDrawable} or {@link FolderAdaptiveIcon}.
   */
            ...
            new Runnable() {
              ...
              public void run() {
                ...
                if (dr instanceof AdaptiveIconDrawable) {
                  ...
                  int blurMargin =
                      (int) mLauncher.getResources().getDimension(R.dimen.blur_size_medium_outline)
                          / 2;
                  ...
                  Utilities.scaleRectAboutCenter(
                      bounds, IconNormalizer.getInstance(mLauncher).getScale(dr, null, null, null));
                  ...
                  mTranslateX =
                      new SpringFloatValue(
                          DragView.this, w * AdaptiveIconDrawable.getExtraInsetFraction());
                  mTranslateY =
                      new SpringFloatValue(
                          DragView.this, h * AdaptiveIconDrawable.getExtraInsetFraction());
   ...
   *     LauncherActivityInfo} or {@link ShortcutInfoCompat}.
   */
  private Drawable getFullDrawable(ItemInfo info, LauncherAppState appState, Object[] outObj) {
    if (info.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION) {
      LauncherActivityInfo activityInfo =
          LauncherAppsCompat.getInstance(mLauncher).resolveActivity(info.getIntent(), info.user);
      outObj[0] = activityInfo;
      return (activityInfo != null)
          ? appState.getIconCache().getFullResIcon(activityInfo, false)
          : null;
      ...
      if (si.isEmpty()) {
        ...
        return sm.getShortcutIconDrawable(
            si.get(0), appState.getInvariantDeviceProfile().fillResIconDpi);
      }
  ...
  private void animateFilterTo(float[] targetFilter) {
    ...
    mFilterAnimator.addUpdateListener(
        new AnimatorUpdateListener() {
