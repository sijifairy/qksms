...
public class InvariantDeviceProfile {
  ...
  @Deprecated int minAllAppsPredictionColumns;
  ...
  InvariantDeviceProfile(Context context) {
    ...
    ArrayList<InvariantDeviceProfile> closestProfiles =
        findClosestDeviceProfiles(minWidthDps, minHeightDps, getPredefinedDeviceProfiles(context));
    ...
    landscapeProfile =
        new DeviceProfile(
            context, this, smallestSize, largestSize, largeSide, smallSide, true /* isLandscape */);
    portraitProfile =
        new DeviceProfile(
            context,
            this,
    ...
    try (XmlResourceParser parser = context.getResources().getXml(R.xml.device_profiles)) {
      ...
      while (((type = parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
        ...
        if ((type == XmlPullParser.START_TAG) && "profile".equals(parser.getName())) {
          ...
          float iconSize = a.getFloat(R.styleable.InvariantDeviceProfile_launcher_iconSize, 0);
          profiles.add(
              new InvariantDeviceProfile(
                  ...
                  a.getInt(
                      R.styleable.InvariantDeviceProfile_minAllAppsPredictionColumns, numColumns),
                  iconSize,
  ...
  ArrayList<InvariantDeviceProfile> findClosestDeviceProfiles(
    ...
    Collections.sort(
        pointsByNearness,
        new Comparator<InvariantDeviceProfile>() {
  ...
  // Package private visibility for testing.
  InvariantDeviceProfile invDistWeightedInterpolate(
      float width, float height, ArrayList<InvariantDeviceProfile> points) {
    float weights = 0;
