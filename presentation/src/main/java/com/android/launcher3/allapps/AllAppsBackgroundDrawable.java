...
public class AllAppsBackgroundDrawable extends Drawable {
  ...
  protected static class TransformedImageDrawable {
     ...
     */
    public TransformedImageDrawable(
        Context context, int resourceId, float xPct, float yPct, int gravity) {
  ...
  public AllAppsBackgroundDrawable(Context context) {
    ...
    mHand =
        new TransformedImageDrawable(
            context, R.drawable.ic_all_apps_bg_hand, 0.575f, 0.f, Gravity.CENTER_HORIZONTAL);
    mIcons = new TransformedImageDrawable[4];
    mIcons[0] =
        new TransformedImageDrawable(
            context, R.drawable.ic_all_apps_bg_icon_1, 0.375f, 0, Gravity.CENTER_HORIZONTAL);
    mIcons[1] =
        new TransformedImageDrawable(
            context, R.drawable.ic_all_apps_bg_icon_2, 0.3125f, 0.2f, Gravity.CENTER_HORIZONTAL);
    mIcons[2] =
        new TransformedImageDrawable(
            context, R.drawable.ic_all_apps_bg_icon_3, 0.475f, 0.26f, Gravity.CENTER_HORIZONTAL);
    mIcons[3] =
        new TransformedImageDrawable(
            context, R.drawable.ic_all_apps_bg_icon_4, 0.7f, 0.125f, Gravity.CENTER_HORIZONTAL);
  }
  ...
  public void animateBgAlpha(float finalAlpha, int duration) {
    ...
    if (getAlpha() != finalAlphaI) {
      ...
      mBackgroundAnim = ObjectAnimator.ofInt(this, LauncherAnimUtils.DRAWABLE_ALPHA, finalAlphaI);
