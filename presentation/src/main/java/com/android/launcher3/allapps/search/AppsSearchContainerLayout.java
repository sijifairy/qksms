...
public class AppsSearchContainerLayout extends FrameLayout
  ...
  protected void onFinishInflate() {
    ...
    spanned.setSpan(
        new TintedDrawableSpan(getContext(), R.drawable.ic_allapps_search),
        0,
        1,
  ...
  public void initialize(AlphabeticalAppsList appsList, AllAppsRecyclerView recyclerView) {
    ...
    mSearchBarController.initialize(
        new DefaultAppSearchAlgorithm(getContext(), appsList.getApps()),
        mSearchInput,
        mLauncher,
        this);
  }
      ...
      if (isKeyNotWhitespace) {
        boolean gotKey =
            TextKeyListener.getInstance()
                .onKeyDown(this, mSearchQueryBuilder, event.getKeyCode(), event);
