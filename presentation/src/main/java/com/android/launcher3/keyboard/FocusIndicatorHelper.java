...
public abstract class FocusIndicatorHelper
    implements OnFocusChangeListener, AnimatorUpdateListener {
  ...
  public static final Property<FocusIndicatorHelper, Float> SHIFT =
      new Property<FocusIndicatorHelper, Float>(Float.TYPE, "shift") {
  ...
  /**
   * The fraction indicating the position of the focusRect between {@link #mCurrentView} & {@link
   * #mTargetView}
   */
  ...
  public void onFocusChange(View v, boolean hasFocus) {
    if (hasFocus) {
      ...
      if (mAlpha > MIN_VISIBLE_ALPHA) {
        ...
        mCurrentAnimation =
            ObjectAnimator.ofPropertyValuesHolder(this, PropertyValuesHolder.ofFloat(ALPHA, 1));
      }
      ...
      if (mLastFocusedView == v) {
        ...
        endCurrentAnimation();
        mCurrentAnimation =
            ObjectAnimator.ofPropertyValuesHolder(this, PropertyValuesHolder.ofFloat(ALPHA, 0));
