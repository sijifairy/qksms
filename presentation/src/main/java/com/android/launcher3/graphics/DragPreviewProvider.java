...
public class DragPreviewProvider {
  ...
  private void drawDragView(Canvas destCanvas) {
    ...
    if (mView instanceof BubbleTextView) {
      ...
      destCanvas.translate(
          -mView.getScrollX() + blurSizeOutline / 2, -mView.getScrollY() + blurSizeOutline / 2);
  ...
  public Bitmap createDragBitmap(Canvas canvas) {
    ...
    Bitmap b =
        Bitmap.createBitmap(
            width + blurSizeOutline, height + blurSizeOutline, Bitmap.Config.ARGB_8888);
    canvas.setBitmap(b);
  ...
  public float getScaleAndPosition(Bitmap preview, int[] outPos) {
    float scale =
        Launcher.getLauncher(mView.getContext())
            .getDragLayer()
