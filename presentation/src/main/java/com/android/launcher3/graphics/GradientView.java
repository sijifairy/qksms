...
/**
 * Draws a translucent radial gradient background from an initial state with progress 0.0 to a final
 * state with progress 1.0;
 */
public class GradientView extends View implements WallpaperColorInfo.OnChangeListener {
  ...
  private void updateColors() {
    this.mColor1 = ColorUtils.setAlphaComponent(mWallpaperColorInfo.getMainColor(), mAlphaColors);
    this.mColor2 =
        ColorUtils.setAlphaComponent(mWallpaperColorInfo.getSecondaryColor(), mAlphaColors);
    if (mWidth + mHeight > 0) {
      createRadialShader();
    }
  }
  ...
  private void createRadialShader() {
    ...
    RadialGradient shaderWithScrim =
        new RadialGradient(
            mWidth * 0.5f,
            mHeight * gradientCenterY,
            radius,
  ...
  public Bitmap createDitheredAlphaMask() {
    ...
    LinearGradient lg =
        new LinearGradient(
            ...
            mMaskHeight,
            new int[] {
              0x00FFFFFF, ColorUtils.setAlphaComponent(Color.WHITE, (int) (0xFF * 0.95)), 0xFFFFFFFF
            },
