...
/**
 * Utility class to generate shadow and outline effect, which are used for click feedback and
 * drag-n-drop respectively.
 */
public class HolographicOutlineHelper {
  ...
  public void applyExpensiveOutlineWithBlur(Bitmap srcDst, Canvas srcDstCanvas) {
    ...
    srcDstCanvas.drawBitmap(
        srcDst, -thickInnerBlurOffset[0], -thickInnerBlurOffset[1], mErasePaint);
    ...
    srcDstCanvas.drawBitmap(
        thickInnerBlur, thickInnerBlurOffset[0], thickInnerBlurOffset[1], mDrawPaint);
    srcDstCanvas.drawBitmap(thickOuterBlur, outerBlurOffset[0], outerBlurOffset[1], mDrawPaint);

    // draw the bright outline
    srcDstCanvas.drawBitmap(
        brightOutline, brightOutlineOffset[0], brightOutlineOffset[1], mDrawPaint);
