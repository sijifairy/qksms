...
public class ShadowDrawable extends Drawable {
  ...
  private void regenerateBitmapCache() {
    Bitmap bitmap =
        Bitmap.createBitmap(
            mState.mIntrinsicWidth, mState.mIntrinsicHeight, Bitmap.Config.ARGB_8888);
  ...
  public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    try {
      ...
      mState.mShadowColor = a.getColor(R.styleable.ShadowDrawable_android_shadowColor, Color.BLACK);
      mState.mShadowSize = a.getDimensionPixelSize(R.styleable.ShadowDrawable_android_elevation, 0);
      mState.mDarkTintColor = a.getColor(R.styleable.ShadowDrawable_darkTintColor, Color.BLACK);
